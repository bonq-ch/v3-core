...
export interface MockTimeUniswapV3PoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "advanceTime"
      | "burn"
  ...
  encodeFunctionData(
    functionFragment: "setFeeGrowthGlobal1X128",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface MockTimeUniswapV3Pool extends BaseContract {
  connect(runner?: ContractRunner | null): MockTimeUniswapV3Pool;
  ...
  setFeeGrowthGlobal0X128: TypedContractMethod<
    [_feeGrowthGlobal0X128: BigNumberish],
    [void],
    "nonpayable"
  >;

  setFeeGrowthGlobal1X128: TypedContractMethod<
  ...
  >;
  getFunction(
    nameOrSignature: "setFeeGrowthGlobal0X128"
  ): TypedContractMethod<
    [_feeGrowthGlobal0X128: BigNumberish],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "setFeeGrowthGlobal1X128"
  ): TypedContractMethod<
    [_feeGrowthGlobal1X128: BigNumberish],
    [void],
    "nonpayable"
